...
def changing_maze(maze, dyna_params):
    ...
    for run in tqdm(range(dyna_params.runs)):
        # set up models
        models = [RegularDynaModel(), TimeDynaModel(kappa=dyna_params.time_weight)]
...
def figure_8_4():
    ...
    plt.savefig('../images/figure_8_4_new_model_new_run.png')
    plt.close()
...
def figure_8_5():
    ...
    plt.savefig('../images/figure_8_5_new_model_new_run.png')
    plt.close()

...
TRUE_VALUE_RET0 = [0, 1 / 6, 2 / 6, 3 / 6, 4 / 6, 5 / 6, 0]  # for 0 return
TRUE_VALUE_RET_M1 = [0, -4 / 6, -2 / 6, 0, 2 / 6, 4 / 6, 0] # for -1 return

TRUE_VALUE = TRUE_VALUE_RET0
RETURN_ON_LEFT = 0
...
if __name__ == '__main__':
    RETURN_ON_LEFT=0
    TRUE_VALUE = TRUE_VALUE_RET0
    figure7_2("figure_7_3_5states_ret0")

    RETURN_ON_LEFT = -1
    TRUE_VALUE = TRUE_VALUE_RET_M1
    figure7_2("figure_7_3_5states_ret-1")
